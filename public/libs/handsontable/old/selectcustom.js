...
(function (Handsontable) {
  ...
  SelectEditor.prototype.init = function(){
    ...
    Handsontable.Dom.addClass(this.select, 'htSelectEditorcustom');
  ...
  SelectEditor.prototype.prepare = function(){
    ...
    for (var option in options){
      if (options.hasOwnProperty(option)){
        ...
        Handsontable.Dom.addClass(optionElement, 'optioncustom');
  ...
  Handsontable.editors.registerEditor('selectcustom', SelectEditor);
